...
grid on;
box on;
print(gcf, '-dpng', '-r350', 'images/singular_values_reduced_2.png')
clf
...
plot3(x(idx0), y(idx0), z(idx0), 'og', 'MarkerFaceColor', 'g', 'MarkerSize', 7, 'DisplayName', 'Class 0 (Healthy)');
plot3(x(idx1), y(idx1), z(idx1), 'or', 'MarkerFaceColor', 'r', 'MarkerSize', 7, 'DisplayName', 'Class 1 (FMA)');
 
set(gcf, 'color', 'w');
set(gcf, 'Position', [100, 100, 800, 600]);
 
view(45, 30);  % Set viewing angle to show all 3 axes
title('SVD -- First 3 Principal Components');
xlabel('Component 1');
ylabel('Component 2');
zlabel('Component 3');
...
print(gcf, '-dpng', '-r350', 'images/svd_results_reduced_2.png')
